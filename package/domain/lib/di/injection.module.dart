...
import 'package:domain/common/common.dart' as _i14;
...
import 'package:domain/entity/dto/portfolio_user_dto.dart' as _i17;
...
import 'package:domain/entity/mapper/portfolio_user_mapper.dart' as _i19;
import 'package:domain/entity/mapper/project_mapper.dart' as _i7;
import 'package:domain/entity/mapper/useful_commands_mapper.dart' as _i16;
...
import 'package:domain/entity/model/portfolio_user_model.dart' as _i18;
import 'package:domain/entity/model/project_model.dart' as _i6;
import 'package:domain/repository/repository.dart' as _i21;
import 'package:domain/usecase/get_contacts_use_case.dart' as _i20;
...
import 'package:domain/usecase/get_useful_commands_use_case.dart' as _i24;
import 'package:domain/usecase/get_user_skills_use_case.dart' as _i25;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i2.FutureOr<void> init(_i1.GetItHelper gh) {
    ...
    gh.factory<_i14.Mapper<_i15.UsefulCommandsDTO, _i15.UsefulCommandsModel>>(
        () => _i16.UsefulCommandsMapper());
    gh.factory<_i4.Mapper<_i17.PortfolioUserDTO, _i18.PortfolioUserModel>>(() =>
        _i19.PortfolioUserMapper(gh<
            _i4.Mapper<_i11.PortfolioSkillsDTO, _i12.PortfolioSkillsModel>>()));
    gh.factory<_i20.GetContactsUseCase>(() => _i20.GetContactsUseCaseImpl(
          gh<_i14.Config>(),
          gh<_i21.UserRepository>(),
          gh<_i14.Mapper<_i15.ContactsDTO, _i15.ContactsModel>>(),
        ));
    gh.factory<_i22.GetProjectByIdUseCase>(() => _i22.GetProjectByIdUseCaseImpl(
          gh<_i14.Config>(),
          gh<_i21.ProjectRepository>(),
          gh<_i14.Mapper<_i15.ProjectDTO, _i15.ProjectModel>>(),
        ));
    ...
    gh.factory<_i24.GetUsefulCommandsUseCase>(() =>
        _i24.GetUsefulCommandsUseCaseImpl(
          gh<_i14.Config>(),
          gh<_i21.UsefulRepository>(),
          gh<_i14.Mapper<_i15.UsefulCommandsDTO, _i15.UsefulCommandsModel>>(),
        ));
    gh.factory<_i25.GetUserSkillsUseCase>(() => _i25.GetUserUseCaseSkillsImpl(
          gh<_i14.Config>(),
          gh<_i21.UserRepository>(),
          gh<_i14.Mapper<_i15.PortfolioSkillsDTO, _i15.PortfolioSkillsModel>>(),
        ));
    gh.factory<_i26.GetUserUseCase>(() => _i26.GetUserUseCaseImpl(
          gh<_i14.Config>(),
          gh<_i21.UserRepository>(),
          gh<_i14.Mapper<_i15.PortfolioUserDTO, _i15.PortfolioUserModel>>(),
        ));
  }
}
